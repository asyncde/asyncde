...
int omp_example(asyncde::Functor1D &fitnessfunctor, unsigned int dim,
  ...
  retvalue = asyncde::omp_optimization_cycle(
...
int main() {
  ...
  int retvalue = omp_example(fitnessfunctor, nvars, vtr, maxfunevals, pop_size);
